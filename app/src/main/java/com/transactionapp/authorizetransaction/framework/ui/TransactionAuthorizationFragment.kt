...
class TransactionAuthorizationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_transaction_authorization, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment TransactionAuthorizationFragment.
         */
        ...
        fun newInstance(param1: String, param2: String) =
            TransactionAuthorizationFragment().apply {
